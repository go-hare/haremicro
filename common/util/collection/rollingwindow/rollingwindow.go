...
type (
	// Option let callers customize the RollingWindow.
...
// New returns a RollingWindow that with size buckets and time interval,
// use opts to customize the RollingWindow.
func New(size int, interval time.Duration, opts ...Option) *RollingWindow {
	if size < 1 {
