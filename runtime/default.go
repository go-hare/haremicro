...
type runtime struct {
	...
	running bool
	// namespaces stores services grouped by namespace, e.g. namespaces["foo"]["hare.micro.auth:latest"]
	// would return the latest version of hare.micro.auth from the foo namespace
